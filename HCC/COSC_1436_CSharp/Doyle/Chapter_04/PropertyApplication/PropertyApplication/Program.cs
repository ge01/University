/* This class constructs an object of the 
 * RealEstateInvestment class. It tests several 
 * properties and methods of the class. A 
 * static method is used in the application class 
 * to input expenses. 
 */
...
namespace PropertyApplication
{
    class RealEstateApp
    {
        static void Main(string[] args)
        {
            ...
            RealEstateInvestment invest1 = new RealEstateInvestment(2004, 150000,
                                                                    "65th Street");
            invest1.MonthlyExpense = GetExpenses();
            invest1.IncomeFromRent = RENTAL_AMOUNT;
            Console.WriteLine();
            Console.WriteLine("Property Location: {0}", invest1.StreetAddress);
            Console.WriteLine("Earnings For Month: {0:C}", invest1.DetermineMonthlyEarnings());
            Console.Read();
        }
